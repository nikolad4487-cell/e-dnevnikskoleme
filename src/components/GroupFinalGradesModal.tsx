...
export default function GroupFinalGradesModal({ isOpen, onClose, classId, subjectId }: Props) {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg p-6">
        <h2 className="text-lg font-black text-gray-900 mb-4">Grupno zaključivanje ocjena</h2>
